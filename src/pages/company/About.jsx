...
const About = () => {
    return (
        <div className="bg-white min-h-screen">
                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="bg-indigo-50 rounded-2xl p-8 border border-indigo-100">
                            <h3 className="font-bold text-indigo-800 mb-4">The Berry Standard</h3>
                            <ul className="space-y-4">
                                {['Zero training required', 'Medical-grade security', 'Beautiful by default', 'Always fast'].map((item, i) => (
                                    <li key={i} className="flex items-center gap-3 text-indigo-700">
            ...
            <section className="py-24 bg-[#0B0623] text-white text-center">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-bold mb-6">Join the movement</h2>
                    <div className="flex justify-center gap-4">
                        <Button size="lg" className="bg-white text-[#0B0623] hover:bg-slate-100">View Careers</Button>
                    </div>
                </div>
            </section>
        </div>
